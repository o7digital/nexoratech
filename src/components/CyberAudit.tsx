...
const cyberLanding = {
  ...
  it: {
    servicesTitle: "Audit pratici per aziende che hanno bisogno di chiarezza, non di allarmismo.",
    servicesText: "Valutiamo l'operazione reale, traduciamo i risultati in rischio di business e lasciamo un piano eseguibile da direzione, IT e utenti.",
    services: [["Audit di cybersicurezza", "Diagnosi professionale per identificare vulnerabilità, validare i controlli attuali e documentare l'esposizione a phishing, ransomware, fuga di dati e interruzioni.", ["Valutazione allineata a NIST CSF", "Revisione accessi, email, rete, endpoint e backup", "Matrice dei rischi per impatto, probabilità e urgenza", "Report esecutivo pronto per la direzione"]], ["Formazione anti-phishing", "Formazione per utenti, manager e team tecnici con casi reali, sessioni live e materiali pratici.", ["Phishing, password, MFA e gestione dati", "Guide per segnalare incidenti rapidamente", "Webinar esecutivi e sessioni per area", "Evidenze interne di sensibilizzazione"]]],
    processTitle: "Dalla diagnosi alla remediation, senza perdere settimane.",
    processText: "Processo pensato per ottenere evidenze rapidamente, prioritizzare il critico e trasformare i risultati in azioni misurabili.",
    process: [["01", "Contesto business", "Sistemi critici, utenti chiave, sedi, fornitori, dati sensibili e scenari di maggiore impatto."], ["02", "Revisione tecnica", "Controlli di identità, email, dispositivi, rete, cloud, backup, policy e risposta agli incidenti."], ["03", "Rischio esecutivo", "Risultati prioritizzati, livello di maturità, impatto probabile e raccomandazioni con responsabili suggeriti."], ["04", "Piano 30 / 60 / 90", "Quick wins, miglioramenti strutturali e formazione per ridurre esposizione tecnica e rischio umano."]],
    academyTitle: "Formazione che riduce il rischio dove iniziano molti attacchi: le persone.",
    academyText: "Sessioni pratiche per rilevare inganni, proteggere accessi, gestire dati sensibili e segnalare in tempo.",
    academy: [["Consapevolezza cyber", "Phishing e frode digitale", "Email false, link malevoli, impersonificazione, social engineering e truffe via WhatsApp o telefono."], ["Accessi sicuri", "Password, MFA e dispositivi", "Protezione account, autenticazione multifattore, password uniche e sicurezza laptop/mobile."], ["Operazione sicura", "Dati, ransomware e incidenti", "Gestione dei dati sensibili, segnali ransomware e protocollo di segnalazione rapido."]],
    plansTitle: "Scegli il livello di profondità di cui la tua azienda ha bisogno.",
    plansText: "Dalla diagnosi rapida ad audit, piano di remediation e programma di awareness cyber.",
    plans: [["Diagnosi Express", "Per PMI che vogliono sapere dove si trovano.", "48h", ["Intervista iniziale", "Checklist NIST CSF", "Report esecutivo breve", "Priorità di miglioramento"]], ["Audit + Piano", "L'offerta principale per trasformare i risultati in esecuzione.", "30/60/90", ["Audit dei controlli", "Matrice dei rischi", "Roadmap di correzione", "Sessione con la direzione"]], ["Awareness Cyber", "Formazione continua per team e aree critiche.", "Corsi", ["Phishing e social engineering", "Password, MFA e accessi", "Gestione sicura dei dati", "Ransomware e segnalazione incidenti"]]],
    quote: {
      tag: "Calcolatore express", title: "Stima l'ambito della tua diagnosi.", text: "Ottieni una referenza rapida in base ad apparecchiature, esposizione digitale, sedi e controlli attuali. L'ambito finale viene validato in una chiamata tecnica.", devices: "Apparecchiature da rivedere", exposure: "Esposizione", exposures: [["1", "Bassa: ufficio ed email"], ["1.18", "Media: cloud e VPN"], ["1.38", "Alta: e-commerce / dati sensibili"]], controls: "Controlli attuali", controlOptions: [["1.15", "Basici o senza evidenza"], ["1", "Parziali: MFA / backup"], [".9", "Maturi: policy e monitoraggio"]], locations: "Sedi", locationOptions: [["0", "1 sede"], ["4500", "2 a 3 sedi"], ["8500", "4+ sedi"]], training: "Aggiungi formazione", trainingOptions: [["0", "Non ora"], ["8500", "Webinar esecutivo"], ["18000", "Webinar + corso registrato"]], result: "Diagnosi Express stimata", note: "Riferimento prima delle imposte. Può variare per ambito tecnico, accessi e urgenza.", delivery: "Consegna", scope: "Ambito", name: "Nome", email: "Email", company: "Azienda", phone: "Telefono", notes: "Note", placeholder: "Indica sistemi critici, sedi o urgenze particolari.", submit: "Invia dati per proposta", success: "Richiesta inviata. Prepareremo la proposta.", error: "Invio non riuscito. Riprova.", labels: { exposure: { "1": "esposizione bassa", "1.18": "esposizione media", "1.38": "esposizione alta" }, controls: { "1.15": "controlli basici", "1": "controlli parziali", ".9": "controlli maturi" }, training: { "0": "Senza formazione aggiuntiva", "8500": "Include webinar esecutivo", "18000": "Include webinar e corso registrato" }, devices: "apparecchiature considerate", scopes: ["PMI", "Azienda media", "Multiarea"] },
    },
  },
} as const;
