...
export const siteCopy = {
  es: {
    ...
    langTag: "es-MX",
    languageLabel: "ES",
    title: "IATERA | Soporte TI, ciberseguridad, desarrollo web y SEO",
    description: "Soporte TI, ciberseguridad, infraestructura, desarrollo web y SEO para empresas en México. Atención remota y en sitio según el alcance.",
    businessDescription: "Soporte técnico para empresas, ciberseguridad en México, infraestructura, páginas web empresariales y SEO en México.",
    offers: ["Help Desk remoto y en sitio", "Auditoría de ciberseguridad", "Administración de servidores", "Reparación y mantenimiento de equipos", "Compra y venta de equipos", "Venta e instalación de componentes", "Desarrollo web empresarial", "SEO técnico y de contenidos"],
    serviceType: "Soporte técnico IT y ciberseguridad",
    alternateLabel: "EN",
    alternateHref: "/en/",
    languageLinks: [["EN", "/en/"], ["FR", "/fr/"], ["DE", "/de/"], ["PT", "/pt/"], ["IT", "/it/"]],
    privacyHref: "/aviso-privacidad/",
    nav: [["Servicios", "#servicios"], ["Help Desk", "/soporte-tecnico-empresas/"], ["Ciberseguridad", "/auditoria-ciberseguridad-nist/"], ["Desarrollo web", "/desarrollo-web-empresarial/"], ["SEO", "/seo-mexico/"], ["Contacto", "#contacto"]],
  ...
  en: {
    ...
    contact: {
      ...
      options: ["Help Desk", "Cyber Audit", "Servers", "Repair", "Equipment", "Components", "Web development", "SEO"],
      loading: "Sending...",
      submit: "Send request",
  ...
  fr: {
    ...
    contact: {
      ...
      options: ["Help Desk", "Cyber Audit", "Serveurs", "Réparation", "Équipements", "Composants", "Développement web", "SEO"],
      loading: "Envoi...",
  ...
  de: {
    ...
    contact: {
      ...
      options: ["Help Desk", "Cyber Audit", "Server", "Reparatur", "Geräte", "Komponenten", "Webentwicklung", "SEO"],
      loading: "Senden...",
  ...
  pt: {
    ...
    contact: {
      ...
      options: ["Help Desk", "Cyber Audit", "Servidores", "Reparo", "Equipamentos", "Componentes", "Desenvolvimento web", "SEO"],
      loading: "Enviando...",
  ...
  it: {
    ...
    contact: {
      ...
      options: ["Help Desk", "Cyber Audit", "Server", "Riparazione", "Apparecchiature", "Componenti", "Sviluppo web", "SEO"],
      loading: "Invio...",
